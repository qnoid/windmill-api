...
HTTP_CODE=$(set -x;curl -s -o /dev/null -w "%{http_code}" -X POST http://192.168.1.2:8080/subscription -d '{"user_identifier":"apple@windmill.io", "user_container":"iCloud.io.windmill.windmill.test"}' -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJ2NnlRaE4xV1BNNzNHanNxSmYybSIsInN1YiI6IjkxYTFiNTU3LWZkZTAtNDE4My1iNjI2LWQwZWM0YTNlNTAxZCIsInR5cCI6InN1YiIsInYiOjF9.-mw5k5re6eSR_rLeyyVtD4ZNc7KrY4W70eusIZ87SAE" -H "content-type: application/json")
